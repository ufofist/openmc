...
!===============================================================================
  ...
  function capacity_int(this) result(capacity)
  ...
  function size_int(this) result(size)
    class(VectorInt), intent(in) :: this
    integer :: size
...
!===============================================================================
  ...
  function capacity_real(this) result(capacity)
  ...
  function size_real(this) result(size)
    class(VectorReal), intent(in) :: this
    integer :: size
